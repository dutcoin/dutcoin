Contributing to dutcoin Core
============================

The dutcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the dutcoin Core project, and is not to be
confused with overall dutcoin Network Protocol consensus changes.

Whether a pull request is merged into dutcoin Core rests with the project merge
...
The project leader is the release manager for each dutcoin Core release.
