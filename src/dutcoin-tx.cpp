...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("dutcoin dutcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dutcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dutcoin transaction") + "\n" +
                               "  dutcoin-tx [options] -create [commands]   " + _("Create hex-encoded dutcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dutcoin transaction
