                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Dutcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&Dutcoin Project"), this);
    webmainAction->setStatusTip(tr("Dutcoin Project Website"));
    ...
    facebookAction->setStatusTip(tr("dutcoin Facebook"));
    ...
    twitterAction->setStatusTip(tr("dutcoin Twitter"));
    ...
    discordAction->setStatusTip(tr("dutcoin Discord"));
    ...
    youtubeAction->setStatusTip(tr("dutcoin Youtube"));
    ...
    telegramAction->setStatusTip(tr("dutcoin Telegram"));
    ...
    redditAction->setStatusTip(tr("dutcoin Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap dutcoin"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell dutcoin Coin (dutcoin)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    dutcoinBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&dutcoin block explorer"), this);
    dutcoinBlockExplorerAction->setStatusTip(tr("dutcoin blockchain explorer"));
    dutcoinBlockExplorerAction->setToolTip(dutcoinBlockExplorerAction->statusTip());
    dutcoinBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&dutcoin Project Github"), this);
    githubAction->setStatusTip(tr("dutcoin Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a dutcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Ditcoin: URIs)"));
...
//    }
    ...
    connect(dutcoinBlockExplorerAction, SIGNAL(triggered()), this, SLOT(dutcoinBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dutcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dutcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dutcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dutcoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Dutcoin Core help message to get a list with possible Dutcoin command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(dutcoinBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Dutcoin Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.dutcoin.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/dutcoin.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/dutcoin4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/dutcoincryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/dutcoin-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::dutcoinBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/dutcoin/dutcoin/"));
}
...
{
    QString strTitle = tr("Dutcoin Core"); // default title
