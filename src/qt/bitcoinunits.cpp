...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case uECA:
            return QString::fromUtf8("Î¼tECA");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case dutcoin:
            return QString("DUT");
        case mECA:
            return QString("Milli-dutcoin (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-dutcoin (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
