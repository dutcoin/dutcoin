...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "dutcoin is born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1615765733;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 1793237;
        ...
        assert(genesis.hashMerkleRoot == uint256("0x961f71daf27c7345fb49ec568e57ddf4325fa093e0f10909b2f08f975e718475"));
        assert(hashGenesisBlock == uint256("0x0000058f395d1e4398281e1aaaa8e45328b04fe305a4378ac7434077130622f3"));

     
		
	vSeeds.push_back(CDNSSeedData("1", "165.232.148.138"));  // san francisco Dutcoin seed
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x961f71daf27c7345fb49ec568e57ddf4325fa093e0f10909b2f08f975e718475"));
        assert(hashGenesisBlock == uint256("0x0000d982e457bf2b1c0f9d0a1a8f7a307c7276c437ff7d12890df05b20358d42"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x961f71daf27c7345fb49ec568e57ddf4325fa093e0f10909b2f08f975e718475"));
        assert(hashGenesisBlock == uint256("0x1df4c9ae97ced303f7f6f4dab51734e3cae53f8fc1c18fcbd351494863d95664"));
