...
In order to support loading of multiple wallets in dutcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dutcoin.cpp.
...
Changes to dutcoin.cpp
----------------------
dutcoin.cpp is the entry point into dutcoin-qt, and as such, will require some minor modifications to provide hooks for
